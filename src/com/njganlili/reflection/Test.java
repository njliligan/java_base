...
class ReflectTest04{
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class.forName("com.njganlili.reflection.Test.MyClass");
    }
}
class MyClass{
    static {
...
class ReflectTest05{
    public static void main(String[] args) throws Exception {
        Class studentClass = Class.forName("com.njganlili.reflection.User");
...
class ReflectTest08{
    public static void main(String[] args) throws ClassNotFoundException {
        Class userServiceClass = Class.forName("com.njganlili.reflection.User");
        // 获取所有的Method（包括私有的！）
...
class ReflectTest11{
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class vipClass = Class.forName("com.njganlili.reflection.User");
